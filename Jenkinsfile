pipeline {
	...
	post {
		always {
			junit allowEmptyResult: true, testResults: 'target/surefire-reports-*.xml, api-test/target/surefire-reports/*.xml, functional-test/target/surefire-reports/*.xml, functional-test/target/failsafe-reports/*.xml'
		}
	}
}
